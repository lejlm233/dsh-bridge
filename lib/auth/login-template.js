  ...
  <div class="container">
    <div class="card">
      ...
      <div id="forgotGuide" style="display: none; margin-top: 14px; padding: 12px 14px; background: rgba(255,255,255,0.04); border: 1px solid rgba(255,255,255,0.08); border-radius: 10px; font-size: 12px; line-height: 1.6; color: var(--text-secondary); text-align: left;">
        ...
        <div style="margin-top: 4px;">2. <strong>服务器 / 无头环境</strong>：救急重置步骤请参见 <a href="https://github.com/lejlm233/dsh-bridge#readme" target="_blank" style="color: #93c5fd;">GitHub README</a> 的「三重容灾保命体系」章节。</div>
      </div>

      <div class="footer">
        由 <a href="https://github.com/lejlm233/dsh-bridge" target="_blank">dsh-bridge</a> 安全网关守护
      </div>
    </div>
  </div>
